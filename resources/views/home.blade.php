...
<html lang="en">
  ...
  <body id="home">
    ...
    <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
      <a class="navbar-brand page-scroll" href="/">Artha Graha Samudera</a>
...
<!-- nilai perusahaan -->
      ...
      <div id="carouselExampleCaptions" class="carousel slide carousel-fade mb-2" data-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="/home/assets/img/bg1.jpeg" class="d-block w-100" alt="...">
          ...
          <div class="carousel-item">
            <img src="/home/assets/img/crane.jpg" class="d-block w-100" alt="...">
            <div class="carousel-caption d-none d-md-block">
          ...
          <div class="carousel-item">
            <img src="/home/assets/img/fototgbg.jpg" class="d-block w-100" alt="...">
            <div class="carousel-caption d-none d-md-block">
          ...
          <div class="carousel-item">
            <img src="/home/assets/img/tiangpancang.jpg" class="d-block w-100" alt="...">
            <div class="carousel-caption d-none d-md-block">
             <!--  <h5>Third slide label</h5>
              <p>Praesent commodo cursus magna, vel scelerisque nisl consectetur.</p> -->
            </div>
  ...
  <!-- contact -->
  <div class="container-fluid bg-contact" id="contactus">
    <div class="container">
      <h2 class="text-center mb-0 pb-4 ml-4">CONTACT US</h2>

      <div class="row">
        <div class="col-lg-5">
          <h3>Write to us !</h3>
          <form class="pt-3 pr-1 mr-3">
            <div class="input-group pb-2">
              <div class="input-group-prepend">
                <span class="input-group-text" id="iconName"><a class="fas fa-user"></a></span>
              </div>
              <input type="text" class="form-control" placeholder="Name" id="formName">
            </div>
            <div class="input-group pb-2">
              <div class="input-group-prepend">
                <span class="input-group-text" id="iconEmail"><a class="fas fa-envelope"></a></span>
              </div>
              <input type="text" class="form-control" placeholder="E-Mail" id="formEmail">
            </div>
            <div class="input-group pb-2">
              <div class="input-group-prepend">
                <span class="input-group-text" id="iconSubject"><a class="fas fa-tag"></a></span>
              </div>
              <input type="text" class="form-control" placeholder="Subject" id="formSubject">
            </div>
            <div class="input-group pb-4">
              <div class="input-group-prepend">
                <span class="input-group-text" id="iconDetail"><a class="fas fa-edit"></a></span>
              </div>
              <textarea class="form-control" id="formDetail" rows="5"></textarea>
            </div>
        ...
        <div class="col-lg-7">
          <div class="">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3958.3502716202315!2d112.73215431477452!3d-7.200817994801339!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dd7f8bc14f01aa5%3A0x69c83c3abaf920da!2sJl.%20Kalianget%20No.126%2C%20RT.000%2FRW.00%2C%20Perak%20Utara%2C%20Kec.%20Pabean%20Cantian%2C%20Kota%20SBY%2C%20Jawa%20Timur%2060165!5e0!3m2!1sid!2sid!4v1600612182774!5m2!1sid!2sid" width="650" height="350" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0" class=""></iframe>
          </div>

          <div class="row text-center pt-5">
            <div class="col-md-4">
              <a class="btn-floating accent-1 con-img "><i class="fas fa-map-marker-alt"></i></a>
              <p class="mb-0 pt-3">Jalan Kalianget No.126 <br> Surabaya</p>
            </div>
            <div class="col-md-4">
              <a class="btn-floating accent-1 con-img "><i class="fas fa-phone"></i></a>
              <p class="mb-0 pt-3">081 551 44 550</p>
            </div>
            <div class="col-md-4">
              <a class="btn-floating accent-1 con-img "><i class="fas fa-envelope"></i></a>
              <p class="mb-0 pt-3">ags.sby96@gmail.com</p>
            </div>
          </div>
        </div>
      </div>
...
<div class="container">
  <div class="row text-center d-flex justify-content-center pt-3">
      <div class="col-md-auto">
          <a href="#aboutus" class="footerLink nav-link page-scroll">About us</a>
      </div>
      <div class="col-md-auto">
          <a href="#service" class="footerLink nav-link page-scroll">Service</a>
      </div>
      <div class="col-md-auto">
          <a href="#project" class="footerLink nav-link page-scroll">Project</a>
      </div>
      <div class="col-md-auto">
          <a href="#article" class="footerLink nav-link page-scroll">Article</a>
      </div>
      <div class="col-md-auto">
          <a href="#contactus" class="footerLink nav-link page-scroll">Contact Us</a>
      </div>
  </div>
  ...
  <div class="row d-flex text-center justify-content-center">
    <div class="col-md-8 col-12">
        <a href="#home" class="footerHome nav-link page-scroll">Artha Graha Samudera</a>
        <p class="footerDetail">- The Best Partner for Your Shipping Need -</p>
     </div>
  </div>
    ...
    <div class="row justify-content-center pt-4 pb-4">
          ...
          <a class="footerIcon" href="#">
            <i class="fas fa-envelope fa-lg mr-4"> </i>
          </a>
          <a class="footerIcon" href="#">
  ...
  <div class="footerCopyright text-center mt-3 pt-3 pb-3">©ARTHAGRAHASAMUDERA2020
  </div>
</div>
</footer>
...
<script src="{{ asset('home/assets/dist/js/script.js') }}"></script>
